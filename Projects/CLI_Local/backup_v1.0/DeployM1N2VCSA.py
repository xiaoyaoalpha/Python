...
# Write console log in the deploy result file in share folder for reference and it will not be removed
cli_deploy_result_file_fullpath_vc01 = os.path.join(DEPLOY_RESULT_FULLPATH, vcName01 + ".txt")
FileOperation.create_file(cli_deploy_result_file_fullpath_vc01, "")
with open(cli_deploy_result_file_fullpath_vc01, "w", encoding='UTF-8') as f:
    for line in cli_deploy_result_list_vc01:
        f.write(line)
print("VC01 deploying log is in share file " + "'" + cli_deploy_result_file_fullpath_vc01 + "'", end="\n")
...
if PSC_IP == "":
    ...
    with open(cli_deploy_result_file_fullpath_vc01, 'r', encoding='UTF-8') as g:
    ...
    if result_vc01:
        with open(cli_deploy_info_file_fullpath, "a", encoding='UTF-8') as h:  # Add information to
            for line in result_vc01:
                h.write(line)
        print("VC01 Deploy info is in Jenkins_slave file " + "'" + cli_deploy_info_file_fullpath + "'", end="\n")
    else:
        with open(cli_deploy_info_file_fullpath, "a", encoding='UTF-8') as h:  # Add information to
            h.write("VC01 deployed failed!" + "\n")
        print("VC01 deployed failed!", end="\n")
        exit()
    print("==================================================================", end="\n")
...
# Write console log in the deploy result file in share folder for reference and it will not be removed
cli_deploy_result_file_fullpath_vc02 = os.path.join(DEPLOY_RESULT_FULLPATH, vcName02 + ".txt")
FileOperation.create_file(cli_deploy_result_file_fullpath_vc02, "")
with open(cli_deploy_result_file_fullpath_vc02, "w", encoding='UTF-8') as f:
    for line in cli_deploy_result_list_vc:
        f.write(line)
print("VC02 deploying log is in share file " + "'" + cli_deploy_result_file_fullpath_vc02 + "'", end="\n")
...
if PSC_IP == "":
    ...
    with open(cli_deploy_result_file_fullpath_vc02, 'r', encoding='UTF-8') as g:
        cli_deploy_result_list_vc = g.readlines()
    for line in cli_deploy_result_list_vc:
        if "Appliance Name" in line:
            appliance_name = line[line.find(":") + 2:]
    ...
    if result_vc02:
        with open(cli_deploy_info_file_fullpath, "a", encoding='UTF-8') as h:  # Add information to
            for line in result_vc02:
                h.write(line)
        print("VC02 Deploy info is in Jenkins_slave file " + "'" + cli_deploy_info_file_fullpath + "'", end="\n")
    else:
        with open(cli_deploy_info_file_fullpath, "a", encoding='UTF-8') as h:  # Add information to
            h.write("VC02 deployed failed!" + "\n")
        print("VC02 deployed failed!", end="\n")
        exit()
    print("==================================================================", end="\n")
